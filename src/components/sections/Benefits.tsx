...
const benefits = [{
  ...
  description: "Otrzymasz zwolnienie nawet w 30 minut, bez wychodzenia z domu i czekania w kolejce."
}, {
  icon: Shield,
  title: "W 100% legalne",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Dlaczego <span className="text-primary">e-zwolnienie (L4) online?</span>
          </h2>
