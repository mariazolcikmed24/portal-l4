...
import { Shield, Clock, Users, ShieldCheck, Lock, Stethoscope, UserRound, Zap, Timer } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          <div className="space-y-4 md:space-y-5">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl">
              Wypełnij krótki formularz, aby uzyskać konsultację lekarską ze zwolnieniem (L4)<br className="md:hidden" /> od <strong className="text-foreground">59 zł</strong>, nawet w <strong className="text-foreground">30 minut</strong>.
            </p>
            ...
            <div className="flex flex-wrap gap-5 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-full border-2 border-secondary/40 flex items-center justify-center flex-shrink-0">
                  <Stethoscope className="w-5 h-5 text-secondary" aria-hidden="true" />
                </div>
