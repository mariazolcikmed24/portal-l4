        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          <div className="space-y-4 md:space-y-5">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl">
              Wypełnij krótki formularz, aby uzyskać konsultację lekarską ze zwolnieniem (L4) od <strong className="text-foreground">59 zł</strong>, nawet w <strong className="text-foreground">30 minut</strong>.
            </p>
