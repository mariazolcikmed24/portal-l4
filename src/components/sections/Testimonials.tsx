...
const testimonials = [{
  ...
  name: "Piotr M.",
  role: "Specjalista IT",
  content: "Profesjonalna obsługa. Formularz przejrzysty, a lekarz szybko przeanalizował zgłoszenie. Wszystko sprawnie i zgodnie z przepisami.",
  rating: 5
}, {
  name: "Magdalena W.",
...
const Testimonials = () => {
  return <section className="pt-8 pb-16 md:pt-12 md:pb-24 bg-white">
