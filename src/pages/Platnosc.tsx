          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="bg-muted/50 p-4 rounded-lg space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Potwierdzenie płatności oraz dokumentacja medyczna po wizycie zostaną przesłane na Twój adres EMAIL podany w formularzu rejestracyjnym - jeśli wiadomość nie pojawi się w skrzynce odbiorczej, prosimy sprawdzić folder SPAM.
              </p>
            </div>
