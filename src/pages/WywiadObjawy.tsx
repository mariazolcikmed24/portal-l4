...
const symptomsByCategory: Record<string, { id: string; label: string }[]> = {
  cold_pain: [
    ...
    { id: "joint_pain", label: "Bóle stawów" },
    { id: "headache", label: "Ból głowy" },
    { id: "dizziness", label: "Zawroty głowy" },
    { id: "runny_nose", label: "Katar" },
    { id: "sneezing", label: "Kichanie" },
    { id: "stuffy_nose", label: "Zatkany nos" },
    ...
    { id: "dry_cough", label: "Kaszel suchy" },
    { id: "wet_cough", label: "Kaszel mokry" },
    { id: "swollen_tonsils", label: "Spuchnięte migdałki" },
    { id: "chest_heaviness", label: "Uczucie ciężkości w klatce piersiowej" },
    { id: "dyspnea", label: "Duszność" },
    { id: "wheezing", label: "Świszczący oddech" },
    { id: "chest_pain_breathing", label: "Ból w klatce piersiowej przy oddychaniu" },
    { id: "watery_eyes", label: "Łzawienie oczu" },
  ],
  gastro: [
    { id: "nausea", label: "Nudności" },
    { id: "vomiting", label: "Wymioty" },
    { id: "watery_diarrhea", label: "Biegunka wodnista" },
    { id: "mucus_diarrhea", label: "Biegunka ze śluzem" },
    { id: "bloody_diarrhea", label: "Biegunka z krwią" },
    { id: "weakness", label: "Osłabienie" },
    { id: "abdominal_pain", label: "Ból brzucha" },
    { id: "no_appetite", label: "Brak apetytu" },
    { id: "food_poisoning", label: "Zatrucie pokarmowe" },
    { id: "heartburn", label: "Zgaga" },
    { id: "fever", label: "Gorączka" },
    { id: "chills", label: "Dreszcze" },
    { id: "dehydration", label: "Odwodnienie (suchość w ustach, małe ilości moczu)" },
    { id: "bloating", label: "Wzdęcia" },
    { id: "gas", label: "Gazy" },
    { id: "fullness", label: "Uczucie rozpierania" },
  ],
  bladder: [
    { id: "frequent_urination", label: "Częste oddawanie moczu" },
    { id: "pollakiuria", label: "Częstomocz" },
    ...
    { id: "bladder_pressure", label: "Parcie na pęcherz" },
    { id: "burning_urination", label: "Pieczenie przy oddawaniu moczu" },
    { id: "lower_abdominal_pain", label: "Ból w podbrzuszu" },
    { id: "lower_belly_pressure", label: "Ból ucisk w dole brzucha" },
    { id: "groin_radiation", label: "Ból promieniujący do krocza lub pachwin" },
    { id: "cloudy_urine", label: "Mętny lub intensywny kolor moczu" },
    { id: "blood_in_urine", label: "Krew w moczu" },
  ],
  injury: [
    ...
    { id: "lumbar_area_pain", label: "Ból w okolicy lędźwiowej" },
    { id: "lumbar_spine_pain", label: "Ból kręgosłupa lędźwiowego" },
    { id: "sprain", label: "Skręcenie stawu" },
    { id: "strain", label: "Nadwyrężenie / przeciążenie" },
    { id: "pain_on_movement", label: "Ból przy ruchu" },
    { id: "limited_mobility", label: "Ograniczenie ruchomości" },
    { id: "swelling", label: "Obrzęk" },
    { id: "bruise", label: "Stłuczenie" },
    { id: "discoloration", label: "Zasinienie, zaczerwienienie" },
    { id: "tenderness", label: "Tkliwość przy dotyku" },
    { id: "stiffness", label: "Sztywność" },
    { id: "pain_worse_on_movement", label: "Ból nasilający się przy ruchu" },
    { id: "hematoma", label: "Krwiak" },
    { id: "joint_instability", label: "Uczucie uciekania stawu" },
    { id: "deformity", label: "Deformacja kończyny" },
    { id: "numbness", label: "Brak czucia" },
    { id: "paresthesia", label: "Drętwienie" },
    { id: "tingling_injury", label: "Mrowienie" },
  ],
  menstruation: [
    { id: "severe_pain", label: "Silne bóle miesiączkowe" },
    { id: "painful_start", label: "Bolesny początek miesiączki" },
    { id: "lower_abdominal_pain_mens", label: "Ból podbrzusza" },
    { id: "abdominal_fullness", label: "Uczucie rozpierania w podbrzuszu" },
    { id: "heavy_bleeding", label: "Obfite krwawienie" },
    { id: "blood_clots", label: "Skrzepy krwi" },
    { id: "abdominal_tenderness", label: "Tkliwość brzucha" },
    { id: "breast_tenderness", label: "Tkliwość piersi" },
    { id: "lower_back_pain", label: "Ból krzyża" },
    { id: "swelling_mens", label: "Obrzęk" },
    { id: "fever_mens", label: "Gorączka" },
    { id: "irritation", label: "Rozdrażnienie" },
    { id: "fatigue_low_mood", label: "Zmęczenie, obniżony nastrój" },
    { id: "mood_swings", label: "Wahania nastroju" },
    { id: "low_mood", label: "Obniżony nastrój" },
    { id: "concentration_difficulty", label: "Trudność z koncentracją" },
  ],
  back_pain: [
  ...
  acute_stress: [
    ...
    { id: "severe_stress", label: "Silny stres" },
    { id: "insomnia", label: "Bezsenność" },
    { id: "anxiety", label: "Lęk/niepokój" },
    { id: "panic_attacks", label: "Napady paniki" },
    { id: "low_mood_stress", label: "Obniżony nastrój" },
    { id: "depressive_symptoms", label: "Objawy depresyjne" },
    { id: "mental_exhaustion", label: "Wyczerpanie psychiczne" },
    { id: "emotional_crisis", label: "Kryzys emocjonalny" },
    { id: "daily_functioning_difficulty", label: "Trudność w codziennym funkcjonowaniu" },
    { id: "lack_of_energy", label: "Poczucie braku sił" },
    { id: "mental_tension", label: "Napięcie psychiczne" },
    { id: "feeling_overwhelmed", label: "Poczucie przeciążenia" },
    { id: "resignation_thoughts", label: "Myśli rezygnacyjne" },
    { id: "feeling_threatened", label: "Uczucie zagrożenia" },
    { id: "chest_pressure", label: "Ucisk w klatce piersiowej" },
    { id: "heart_palpitations", label: "Kołatanie serca" },
    { id: "anger_outbursts", label: "Wybuchy złości" },
    { id: "frequent_waking", label: "Częste wybudzanie się" },
    { id: "daytime_sleepiness", label: "Senność w ciągu dnia" },
    { id: "nightmares", label: "Koszmary senne" },
    { id: "suicidal_thoughts", label: "Myśli samobójcze" },
  ],
  psych: [
    { id: "family_problems", label: "Problemy rodzinne" },
    { id: "divorce", label: "Stres (rozwód)" },
